...
m_WaterText[ 1 ] = Locale.ConvertTextKey("TXT_KEY_OPSCREEN_SETTINGS_HIGH");
...
for i = 1, m_iResolutionCount+1, 1  do
    local width, height, refresh, scale, display, adapter = UIManager:GetResInfo( i-1 );
    m_FullscreenResList[i-1] = { Width = width,
                            Height = height,
                            Refresh = refresh,
                            Display = display,
                            Adapter = adapter };
